...
try:
    # Get all datasets using the static method with auto-pagination
...
<Note>
**Pagination Support:**
- The method returns a **generator** that yields individual datasets
...
*   Filter datasets by specific data types (image, video, audio, etc.)
