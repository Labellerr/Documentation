...
<Steps>
  ...
  <Step title="Get your API Key and Secret">
    ...
    Copy your `api_key` and `api_secret` from this page.
  </Step>
  
  <Step title="Request your Client ID">
    To obtain your `client_id`, please contact our [support team](mailto:support@tensormatics.com?subject=Request%20for%20Client%20ID&body=Hi%20team,%0A%0AI%20would%20like%20to%20request%20my%20Client%20ID.%0A%0AMy%20name%3A%20%3Cyour%20name%3E%0AMy%20workspace%20ID%3A%20%3Cyour%20workspace%20ID%3E%0AMy%20email%20used%20in%20the%20workspace%3A%20%3Cyour%20email%3E%0APurpose%20of%20request%3A%20%3Cbrief%20reason%3E%0A%0AThank%20you).
  </Step>
</Steps>
