...
```python KeyFrame Structure lines icon="code" highlight={1-6}
from labellerr.core.schemas import KeyFrame
...
```python Add/Update Keyframes lines icon="plus" highlight={8-18}
from labellerr.client import LabellerrClient
from labellerr.core.projects import LabellerrProject
from labellerr.core.schemas import KeyFrame
...
```python Batch Keyframe Creation lines icon="layer-group" highlight={7-17}
from labellerr.core.schemas import KeyFrame
...
```python Delete Keyframes lines icon="trash" highlight={8-12}
from labellerr.client import LabellerrClient
from labellerr.core.projects import LabellerrProject
...
```python Complete Keyframe Workflow lines icon="rocket" highlight={7-12,15-21,24-29,32-35}
from labellerr.client import LabellerrClient
from labellerr.core.projects import LabellerrProject
from labellerr.core.schemas import KeyFrame
from labellerr.core.exceptions import LabellerrError
...
```python Error Handling Example lines icon="shield" highlight={3-12}
from labellerr.core.exceptions import LabellerrError
...
```python Custom Keyframe Logic lines icon="code" highlight={5-21}
