...
<AccordionGroup>
  <Accordion title="Dataset has no files error" icon="circle-exclamation">
    ...
    **Cause:** The dataset was created but files haven't finished uploading or no files were provided.
    
    **Solution:**
    - Wait for dataset upload to complete
    - Check `dataset.files_count` before creating project
