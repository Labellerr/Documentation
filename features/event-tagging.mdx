...
<iframe 
  ...
  title="Event Tagging with Attributes" 
  frameborder="0" 
  allowfullscreen>
</iframe>

### How to Add Attributes to Event Tags

1. **Configure Attributes in Project Setup:** Define the attributes and options (e.g., dropdowns, checkbox selections) linked to your event label in the project settings.
2. **Tag an Event:** Create your event tag on the video timeline.
3. **Assign Attributes:** Once the event annotation is created, select the annotation and press **E** on the keyboard to fill in the attributes you have created.
