...
| `s3:GetBucketCors` | Get CORS configuration |
| `s3:GetBucketLocation` | Get bucket region |
| `s3:PutBucketCors` | Set CORS policy (or configure manually) |
  </Tab>
...
**Cause:** Files have not been moved to the expected workflow stage (review, client_review, or accepted).
